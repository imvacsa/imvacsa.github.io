...
- `index.html`: 홈페이지. 최근에 추가한 앨범 3개를 최신순으로 자동 표시합니다.
...
새 앨범은 배열 맨 뒤에 추가하세요. 홈페이지에는 최근 3개가 최신순으로, 전체 목록에는 모든 앨범이 추가 순서대로 표시됩니다. 새 HTML을 만들 필요 없이 `album.html?id=new-album` 주소가 생깁니다. 배포는 GitHub Pages의 기존 설정을 사용합니다.
